...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "CGL Digital — Diseño Web Profesional" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CGL Digital | Diseño Web Profesional" },
      { name: "twitter:description", content: "Creamos páginas web modernas, rápidas y optimizadas para ayudar a empresas y emprendedores a conseguir más clientes y fortalecer su presencia digital." },
